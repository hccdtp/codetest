...
(function(a){
	addTrustForm = 
	{
		init:function()
		{
			...
			jQuery(document).on("click", ".setting-element-title > div.subject > span.content, .setting-element-title > div.submessage > span.content", function(){
			...
			jQuery(document).on("click", ".edit-button", function(){
				...
				jQuery(document).on("click", ".del-icon", function(){
			...
			//要素タイトルのinput内を塗りつぶす
			jQuery(document).on("mouseover", ".setting-element-title", function(){
				a(this).addClass("element-title-hover");
			});
			
			//バリデーション設定のボックスのスライド
			jQuery(document).on("click", "input[name=textbox-char-num]", function(){
				a(this).parent().next().slideToggle("fast");
			});

			//バリデーション設定のボックスのスライド
			jQuery(document).on("click", "input[name=textbox-multi-characters]", function(){
			...
			//バリデーション設定のボックスのスライド
			jQuery(document).on("click", "input[name=textbox-characters]", function(){
			...
			//バリデーション設定のボックスのスライド
			jQuery(document).on("click", "input[name=textarea-char-num]", function(){
				a(this).parent().next().slideToggle("fast");
			});

			//inputとtextareaにフォーカスを当てる
			jQuery(document).on("click", "#setting-form input, #setting-form textarea", function() {
				a(this).focus();
			});
...
//					v = v.replace(/<br>/g, "\r\n");
		...
		setupButton: function(a){
			...
			//input formサブミットボタンのxボタン押下時。編集状態を解除する
			...
			//confirm formサブミットボタンのxボタン押下時。編集状態を解除する
